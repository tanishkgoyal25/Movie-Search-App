...
export default function Header(props) {
     return (
          <header className="w-full bg-black">
               <div className="max-w-7xl h-[75px] mx-auto flex items-center justify-between">
                    <div className="ml-[25px] p-2.5">
                    ...
                    <div className="w-[750px] border border-white rounded-full bg-white p-2.5 flex items-center">
                         <input type="search" value={props.search} onChange={(event) => props.setSearch(event.target.value)} className="h-[25px] outline-none grow" />
